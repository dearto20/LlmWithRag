...
public class StationaryTimeRepository extends KnowledgeRepository<Long> {
    private static final String TAG = StationaryTimeRepository.class.getSimpleName();
    private static final String NAME_SHARED_PREFS = "stationary_duration";
    private final Context mContext;

    public StationaryTimeRepository(Context context) {
        mContext = context;
    }
